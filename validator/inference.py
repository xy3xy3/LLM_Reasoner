...
def reason(premises, conclusion, constants_dict, predicates_dict, origin_premises, origin_conclusion):
    solver = Solver()
...
def inference(instance):
    ...
    case1 = reason(premises, conclusion, constants_dict, predicates_dict, instance["response"], instance["conclusion-AI"])
    case2 = reason(premises, "Not("+conclusion+")", constants_dict, predicates_dict, instance["response"], instance["conclusion-AI"])
